...
test("should display table with pipeline execution data", async ({
  gotoPanelEditPage,
  ...
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Name/i }),
  ).toBeVisible();
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /History/i }),
  ).toBeVisible();
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Last Outcome/i }),
  ).toBeVisible();
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Last Duration/i }),
  ).toBeVisible();
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Total Runs/i }),
  ).toBeVisible();
...
test("should display task execution data without queue column", async ({
  ...
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Last Queue/i }),
  ).not.toBeVisible();
});
...
test("should display test suite data with test breakdown columns", async ({
  ...
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Passed/i }),
  ).toBeVisible();
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Failed/i }),
  ).toBeVisible();
  await expect(
    panelEditPage.panel.locator.getByRole("columnheader", { name: /Skipped/i }),
  ).toBeVisible();
