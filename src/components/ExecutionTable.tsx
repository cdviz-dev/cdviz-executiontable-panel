...
import { ExecutionTableOptions, ExecutionRow, getOutcomeColor } from '../types';
...
export const ExecutionTable: React.FC<PanelProps<ExecutionTableOptions>> = ({ data, options, width, height }) => {
      ...
      >
        <div style={{ textAlign: 'center', padding: '20px' }}>
          ...
          <div style={{ fontSize: '0.9em' }}>
            Check your query returns data with required columns: Name, Run History (s), Outcome History, Run IDs, URLs
          </div>
        </div>
      </div>
    );
      ...
      >
        <thead>
          ...
          >
            ...
            <th style={{ padding: '12px 8px', textAlign: 'left', fontWeight: 600 }}>History</th>
            <th style={{ padding: '12px 8px', textAlign: 'center', fontWeight: 600 }}>Last Outcome</th>
            <th
              style={{
                padding: '12px 8px',
                textAlign: 'right',
            ...
            >
              P{options.durationPercentile || 80} Duration{renderSortIcon('P80 Duration (s)')}
            </th>
            <th
              style={{
                padding: '12px 8px',
        ...
        <tbody>
          {sortedRows.map((row, index) => (
            ...
            >
              <td style={{ padding: '8px', fontWeight: 500, whiteSpace: 'nowrap' }}>{row.Name}</td>
              ...
              {options.showQueueHistory && (
                <td style={{ padding: '8px', textAlign: 'right', whiteSpace: 'nowrap' }}>
                  {row['Last Queue (s)'] !== undefined ? `${row['Last Queue (s)'].toFixed(1)}s` : '-'}
                </td>
              )}
              <td style={{ padding: '8px', textAlign: 'right', whiteSpace: 'nowrap' }}>
