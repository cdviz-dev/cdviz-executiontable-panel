...
export const plugin = new PanelPlugin<ExecutionTableOptions>(ExecutionTable).setPanelOptions((builder) => {
  return builder
    .addNumberInput({
    ...
    .addNumberInput({
      ...
      description: 'Percentile to display for duration (e.g., 50 for P50, 80 for P80, 95 for P95)',
      defaultValue: 80,
      settings: {
        min: 1,
        max: 99,
